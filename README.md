...
radio_probe_interval_seconds = 300   # how often to probe radio for zombie connections (seconds)
radio_probe_fail_threshold = 3       # consecutive probe failures before automatic reconnect
